    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'User'), ('moderator', 'Moderator'), ('admin', 'Administrator')], default='user', max_length=10, verbose_name='Права пользователя')),
                ('email', models.EmailField(max_length=50, unique=True, verbose_name='Email адресс')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(blank=True, unique=True, verbose_name='Адрес жанра')),
            ],
            options={
                'ordering': ['name'],
            },
